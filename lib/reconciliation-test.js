...
function runReconciliation() {
    ...
    const csvPath = path_1.default.join(rawDir, 'campaign_metrics', '2025_metrics.csv');
    const csvData = readCSV(csvPath);
    const csvCampaignIds = new Set();
    let csvTotalCost = 0;
    ...
    console.log('═'.repeat(70));
    console.log();
    const allMatch = Math.abs(costDiffPercent) < 0.01 &&
